...
namespace voobly_drs_merger
{
    ...
    internal class frame
    {
        ...
        {
            this.picture = frame.RectangularArrays.RectangularIntArray(h, w);
        }
        ...
        internal virtual void drawplayercolors(int row, byte[] data, int player)
        {
            ...
            for (int index = 0; index < length; ++index)
            {
                ...
                if (num1 < 0)
                    num1 += 256 /*0x0100*/;
                int num2 = player * 16 /*0x10*/ + 16 /*0x10*/ + num1;
        ...
        internal virtual void cmdcolorblock(byte[] array, bool playercolorused)
        {
            ...
            int length2 = 0;
            int index1 = 0;
            bool flag1 = ((array[index1] < (byte)16 /*0x10*/ ? 0 : (array[index1] <= (byte)23 ? 1 : 0)) & (playercolorused ? 1 : 0)) != 0;
            if (flag1)
            {
                num2 = 0;
                length2 = 1;
            ...
            {
                bool flag2 = ((array[index2] < (byte)16 /*0x10*/ ? 0 : (array[index2] <= (byte)23 ? 1 : 0)) & (playercolorused ? 1 : 0)) != 0;
                if (flag2 && !flag1)
                {
                ...
                else if (!flag2 & flag1)
                {
                    ...
                    for (int index4 = 0; index4 < length2; ++index4)
                        array2[index4] = array[num2 + index4];
            ...
            if (flag1)
            {
                ...
                for (int index5 = 0; index5 < length2; ++index5)
                    array3[index5] = array[num2 + index5];
                this.cmdplayercolor(array3);
            }
            else
            {
                byte[] array4 = new byte[length1];
                for (int index6 = 0; index6 < length1; ++index6)
                    array4[index6] = array[num1 + index6];
                this.cmdcolor(array4);
            }
        }
        ...
        internal virtual void cmdplayercolor(byte[] array)
        {
            ...
            else
            {
                ...
                for (int index = 0; index < array.Length; ++index)
                    d[index] = (byte)(((int)array[index] & (int)byte.MaxValue) - 16 /*0x10*/);
        ...
        internal virtual void cmdoutline1(int n)
        {
            ...
            {
                this.commands[this.numcommands] = new commandclass((byte)94, (byte)n1);
                ++this.numcommands;
            }
        }
        ...
        internal virtual void cmdoutline2(int n)
        {
            ...
            {
                this.commands[this.numcommands] = new commandclass((byte)126, (byte)n1);
                ++this.numcommands;
            }
        }
        ...
        internal virtual void cmdshadowpix(int n)
        {
            ...
            {
                byte n3 = (byte)num;
                this.commands[this.numcommands] = new commandclass(b, n3);
                ++this.numcommands;
            }
        }
        ...
        internal virtual void computecommandbytes()
        {
            ...
            {
                switch (this.commands[index].type)
                {
                    case "one":
                        ++num;
                        break;
