...
namespace voobly_drs_merger
{
    ...
    {
        public Image img;
        internal byte[][] colortable = imagehandler.RectangularArrays.RectangularbyteArray(256 /*0x0100*/, 4);
        public byte[][] aoktable = imagehandler.RectangularArrays.RectangularbyteArray(256 /*0x0100*/, 4);
        public int[] mapping = new int[256 /*0x0100*/];
        public int mask;
        ...
        public virtual void loadbitmap(string filename, int whichfile)
        {
            try
            {
                ...
                int num9 = ((int)buffer2[7] & (int)byte.MaxValue) << 24 | ((int)buffer2[6] & (int)byte.MaxValue) << 16 /*0x10*/ | ((int)buffer2[5] & (int)byte.MaxValue) << 8 | (int)buffer2[4] & (int)byte.MaxValue;
                int num10 = ((int)buffer2[11] & (int)byte.MaxValue) << 24 | ((int)buffer2[10] & (int)byte.MaxValue) << 16 /*0x10*/ | ((int)buffer2[9] & (int)byte.MaxValue) << 8 | (int)buffer2[8] & (int)byte.MaxValue;
                ...
                int num17 = (int)buffer2[16 /*0x10*/];
                int num18 = ((int)buffer2[23] & (int)byte.MaxValue) << 24 | ((int)buffer2[22] & (int)byte.MaxValue) << 16 /*0x10*/ | ((int)buffer2[21] & (int)byte.MaxValue) << 8 | (int)buffer2[20] & (int)byte.MaxValue;
                int num19 = (int)buffer2[27];
                int num20 = (int)buffer2[26];
                int num21 = (int)buffer2[25];
                int num22 = (int)buffer2[24];
                int num23 = (int)buffer2[31 /*0x1F*/];
                int num24 = (int)buffer2[30];
                int num25 = (int)buffer2[29];
                int num26 = (int)buffer2[28];
                int num27 = ((int)buffer2[35] & (int)byte.MaxValue) << 24 | ((int)buffer2[34] & (int)byte.MaxValue) << 16 /*0x10*/ | ((int)buffer2[33] & (int)byte.MaxValue) << 8 | (int)buffer2[32 /*0x20*/] & (int)byte.MaxValue;
                ...
                else
                {
                    ...
                    if (num18 == 0)
                        num18 = ((int)((long)(num9 * num13 + 31 /*0x1F*/) & 4294967264L) >> 3) * num10;
        ...
        public virtual void setplayercolor()
        {
            ...
            for (int index1 = 0; index1 < 256 /*0x0100*/; ++index1)
            {
                ...
                if (num2 != 0)
                {
                    ...
                    {
                        if (this.mapping[index3] == index1)
                            this.mapping[index3] = num2;
                    }
                }
            }
            this.getmask();
