...
namespace voobly_drs_merger
{
    ...
    internal class Aokbitmap
    {
        ...
        public byte[] bfType = new byte[2] { (byte)66, (byte)77 };
        public int bfSize;
        ...
        public int biSizeImage = 196608 /*0x030000*/;
        ...
        internal virtual void convertimage(int[][] picture, int width, int height)
        {
            ...
            this.bfSize = this.biSizeImage + 14 + 40 + 1024 /*0x0400*/;
            this.biWidth = width;
      ...
      (byte) (parValue & (int) byte.MaxValue),
      (byte) (parValue >> 8 & (int) byte.MaxValue),
      (byte) (parValue >> 16 /*0x10*/ & (int) byte.MaxValue),
